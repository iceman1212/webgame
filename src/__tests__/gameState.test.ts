...
describe('GameState', () => {
  ...
  describe('reset', () => {
    it('应该重置所有状态到初始值', () => {
      ...
      gameState.balloons = [{ x: 0, y: 0, val: 5, image: {} as HTMLImageElement, speed: 1, floatOffset: 0 }];
  ...
  describe('removeBalloon', () => {
    it('应该移除指定的气球', () => {
      const balloon1: Balloon = { x: 0, y: 0, val: 5, image: {} as HTMLImageElement, speed: 1, floatOffset: 0 };
      const balloon2: Balloon = { x: 100, y: 0, val: 3, image: {} as HTMLImageElement, speed: 1, floatOffset: 0 };
    ...
    it('当移除最后一个气球时应该返回 true', () => {
      const balloon: Balloon = { x: 0, y: 0, val: 5, image: {} as HTMLImageElement, speed: 1, floatOffset: 0 };
